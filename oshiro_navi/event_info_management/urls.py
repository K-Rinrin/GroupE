...
urlpatterns = [
    ...
    path('admin/update/<int:pk>/', AdminEventInfoUpdateView.as_view(), name='admin_event_info_update'),
    path('admin/update_success/',AdminEventInfoUpdateSuccessView.as_view(), name='admin_event_info_update_success'),
    path('admin/delete/<int:pk>/', AdminEventInfoDeleteView.as_view(), name='admin_event_info_delete'),
    path('admin/delete_success/',AdminEventInfoDeleteSuccessView.as_view(), name='admin_event_info_delete_success'),
    path('Admin/detail/<int:pk>/',AdminEventInfoDetailView.as_view(), name='admin_event_info_detail'),
    ...
    path('operator/detail/<int:pk>/',OperatorEventInfoDetailView.as_view(), name='operator_event_info_detail'),
]
